                    ...
                    <div class="card">
                        ...
                        <div class="card-body description-box">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <p class="text-muted">{{ $data->amount }} Bola</p>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between">
                            <button type="button" data-id="{{ $data->id }}" class="btn btn-info btn-round w-100 mr-2 btn-edit">
                                <i class="fas fa-pen"></i>
                            </button>
                            <button type="button" data-id="{{ $data->id }}" class="btn btn-danger btn-round w-100 btn-delete">
            ...
            <div class="modal-body">
                <form action="{{route('admin.product.store')}}" method="post" id="formCreate">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">Product <small class="text-danger">*</small></label>
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Product" class="form-control">
                    </div>
                    <div class="form-group mb-3">
           ...
           $.ajax({
               ...
               success : function(data){
                   if(data?.success){
                        ...
                        formEdit.attr('action',`{{ route("admin.product.store") }}/update/${ball?.id}`);
